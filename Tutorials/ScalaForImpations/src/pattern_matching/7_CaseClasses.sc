...
def caseClassPatternDemo(x:Amount): String = {
 return x match {
    ...
    case Currency(v,_) => s"Currency is not interested (_) and amount is ${v} "
...
// 3. Automatically provides the companion object and gets the apply factory method Dollar(100) instead of new Dollar(100)
